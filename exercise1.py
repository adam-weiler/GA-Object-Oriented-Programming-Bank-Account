class BankAccount: #A Bank Account class.
    ...
    def __str__(self): #Returns a meaningful string that describes the instance.
        return f'BankAccount instance:balance={self.balance} interest_rate={self.interest_rate}'
    ...
    def display_balance(self): #Returns an plain-English string that describes the instance.
...
print(first_account.display_balance()) #Prints the plain-English after the calculations are complete.
print()
...
second_account.withdraw(680) #Calls the withdraw instance method.{self.name}
...
print(second_account.display_balance()) #Prints the plain-English after the calculations are complete.
print()
...
print(third_account.display_balance()) #Prints the plain-English after the calculations are complete.
print()

#These are extra things inside the third_account object.
